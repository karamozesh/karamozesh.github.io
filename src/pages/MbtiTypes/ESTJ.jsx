    ...
    <main>
      ...
      <section className="container mx-auto  mt-10 p-20 font-medium   ">
        ...
        <div className=" p-5 text-[#545C6D] ">
          <p className="text-xl">
          مجریان نمایندگان سنت و نظم هستند و از درک خود در مورد امور درست، 
          نادرست و قابل قبول اجتماع برای گردهم آوردن خانواده‌ها و جوامع استفاده می‌کنند. 
          افراد دارای گونه شخصیتی مجری از ارزش‌های صداقت، فداکاری و کرامت استقبال می‌کنند و 
          دیگران به‌خاطر مشاوره‌ها و راهنمایی‌های روشن آنها برایشان ارزش قائل هستند، و از اینکه 
          در مسیرهای دشوار پیشرو باشند خرسندند. مجریان که از گردهم آوردن افراد در کنار هم احساس غرور می‌کنند، 
          اغلب نقش سازمان‌دهندگان اجتماعی را ایفا می‌کنند و با سختکوشی همه 
          افراد را برای شرکت در جشن رویدادهای محلی، یا در دفاع از 
          ارزش‌های سنتی که خانواده‌ها و جوامع را در کنار هم نگه می‌دارد، گردهم می‌آورند.
          </p>
        </div>
        ...
        مجریان تصویری کلاسیک از شهروندان سرمشق هستند: آن‌ها به همسایگان خود کمک می‌کند، 
        به قانون وفادار هستند و سعی می‌کنند مطمئن شوند همه در جوامع و 
        سازمان‌هایی که تا آن اندازه برایشان عزیز است مشارکت می‌کنند.

        </div>

        <div className=" p-5 text-[#545C6D]">
          <p className="text-xl">
          چالش اصلی پیش روی افراد دارای این گونه شخصیتی مجری این است که بدانند همه افراد 
          از یک مسیر پیروی نمی‌کنند یا به شیوه‌ای مشابه یاری نمی‌رسانند. یک رهبر واقعی قدرت افراد، و همچنین گروه را به رسمیت می‌شناسد، و کمک می‌کند تا نظرات آن افراد مطرح گردد. به این ترتیب، شخصیت‌های مجری به‌راستی تمام واقعیت‌ها را در اختیار دارند، و قادر هستند کارها را به شیوه‌ای پیش ببرند که برای همه مفید باشد.
          </p>
        </div>
