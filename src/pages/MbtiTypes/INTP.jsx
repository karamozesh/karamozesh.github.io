...
function INTP() {
  return (
    <main>
            ...
            <HeaderType  typeName = {'منطق‌دان'} type={'INTP-A / INTP-T'} typeImg = {intp}/>
      


        <section className='container mx-auto  mt-10 p-20 font-medium   '>
            <h1 className='text-5xl text-[#51596A] pb-5'>شخصیت منطق دان</h1>
            <div className=' p-5 text-[#545C6D] border-4 border-t-0 border-b-0 border-l-[#33A474] border-r-[#33A474] border-5'> 
               ...
               <span className='p-3 text-[#B5B5B5]'>ALBERT EINSTEIN</span>
               </div>
               ...
               <div className=' p-5 text-[#545C6D] mt-5'>
                <h2 className='text-5xl text-[#51596A] pb-5'> زندگی آزموده نشده ارزش زیستن ندارد</h2>
                <p className='text-xl'>
               ...
               <div class="description-pullout">منطق‌دانان به‌خاطر نظریه‌های درخشان و منطق نیرومند خود شناخته می‌شوند - در حقیقت، آن‌ها منطقی‌ترین گونه بین تمام گونه‌های شخصیتی در نظر گرفته می‌شوند.
            </div>
               <div  className=' p-5 text-[#545C6D]'>
                    <p className='text-xl'>
