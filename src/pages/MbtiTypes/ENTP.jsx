  ...
  return (
    <main>
        ...
        <section className='container mx-auto  mt-10 p-20 font-medium   '>
            <h1 className='text-5xl text-[#51596A] pb-5'>شخصیت مجادله گر</h1>
            <div className=' p-5 text-[#545C6D] border-4 border-t-0 border-b-0 border-l-[#33A474] border-r-[#33A474] border-5'> 
               ...
               <span className='p-3 text-[#B5B5B5]'>THOMAS J. WATSON</span>
               </div>
               ...
               <div className=' p-5 text-[#545C6D] mt-5'>
                <h2 className='text-5xl text-[#51596A] pb-5'>در اینجا هیچ قانونی وجود ندارد - ما داریم تلاش می‌کنیم کاری را به انجام برسانیم.</h2>
                <p className='text-xl'>
               ...
               ناقض غریبی در مورد مجادله‌گران رخ می‌دهد زیرا آنها واقعاً صادق هستند، اما به‌طور خستگی‌ناپذیر برای اثبات چیزهایی استدلال می‌کنند که در واقع به آنها باور ندارند یعنی پای خود را در کفش دیگران می‌کنند تا در مورد یک حقیقت از منظری دیگر استدلال نمایند
               </div>
        ...
        <PersonTypes img1={Margaret} name1={"Thatcher"} img2={Margaret} name2={"Thatcher"} img3={Margaret} name3={"Thatcher"} img4={Margaret} name4={"Thatcher"}/>
